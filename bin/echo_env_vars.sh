...
echo_env_vars()
{
  ...
  echo CYBER_DOJO_SAVER_SHA=f4bb3412725258648a7cf5ce1a776609b4dade72
  echo CYBER_DOJO_SAVER_TAG=f4bb341
  
  echo CYBER_DOJO_SPOOLER_SHA=980ae498f573640d29b4f6442ee63aab67a9a7d7
  echo CYBER_DOJO_SPOOLER_TAG=980ae49
