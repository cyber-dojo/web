...
echo_env_vars()
{
  ...
  echo CYBER_DOJO_SAVER_SHA=ee2eb5fb0b9f0eeabd19474b9cde1d73f4d52df0
  echo CYBER_DOJO_SAVER_TAG=ee2eb5f
  
  echo CYBER_DOJO_SPOOLER_SHA=6dee85955be38bf845504d34469468e9c7d2fa6f
  echo CYBER_DOJO_SPOOLER_TAG=6dee859  
