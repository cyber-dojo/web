...
# but raises a SaverService::Error on the run_tests save. Drives the run_tests
# rescue path for a transient saver failure (saver down/overloaded/500/reset).
# Injected via CYBER_DOJO_SAVER_CLASS.
